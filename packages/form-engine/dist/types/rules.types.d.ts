...
export type TransitionGuard = (data: any, context?: TransitionContext) => boolean | Promise<boolean>;
...
export declare const isLogicalRule: (rule: Rule) => rule is LogicalRule;
export declare const isComparisonRule: (rule: Rule) => rule is ComparisonRule;
export declare const isCustomRule: (rule: Rule) => rule is CustomRule;
export declare const isAlwaysRule: (rule: Rule) => rule is AlwaysRule;

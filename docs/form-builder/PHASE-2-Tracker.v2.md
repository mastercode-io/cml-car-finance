...
- [x] P2‑09 — Minimal rollback runbook
...
| P2‑09 | Minimal rollback runbook          | 568d1252ef3dd940fb4b3e5a6204db2097dfb772 | local (prettier/lint/typecheck/test/build/size) | Added CDN retention runbook, manifest pin script, and Jest coverage; lint keeps legacy any warnings and build skips Google Fonts offline.                        |

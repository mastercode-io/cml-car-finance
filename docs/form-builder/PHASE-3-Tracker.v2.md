...
| P3-03        | Review step (summary-only)                          | P0  | `feat/p3-03-review-250925-200818` | _draft_     | In Review   | ✅ fmt/lint/type/test/build/size   | Draft PR adds terminal review policy, freeze handling, summary UI. |
